...
class CharsTrimmerTest extends TestCase
{
    ...
    public function testStringAssignable()
    {
        ...
        $trim = new CharsTrimmer($this->testText);
    ...
    public function testLengthAssignable()
    {
        ...
        $trim = new CharsTrimmer($this->testText, $this->testLength);
        $class = new ReflectionClass($trim);
    ...
    public function testNotNumberLengthThrowException()
    {
        ...
        $trim = new CharsTrimmer($this->testText, $length='not a number'); // should throw exception
    }
    ...
    public function testNegativeLengthThrowException()
    {
        ...
        $trim = new CharsTrimmer($this->testText, $length=-10); // should throw exception
    }
    ...
    {
        // create new trimmer object with negative length
        $trim = new CharsTrimmer($this->testText, $length=2.5); // should throw exception
    }
    ...
    {
        // create new trimmer object with negative length
        $trim = new CharsTrimmer(234234234); // should throw exception
    }
    ...
    {
        $trim = new CharsTrimmer($this->testText, $this->testLength, $delimiter='//');
        $class = new ReflectionClass($trim);
